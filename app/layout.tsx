          ...
          <SidebarProvider>
            <div className="flex h-screen w-screen scrollbar-thin bg-background">
              ...
              <div className="flex-1 p-4 overflow-hidden">
                <main className="h-full overflow-auto scrollbar-thin rounded-2xl border border-border/20 shadow-lg bg-gradient-to-br from-background via-contrast-lightest to-contrast-lighter">{children}</main>
              </div>
            </div>
          </SidebarProvider>
          <Toaster />
